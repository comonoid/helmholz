...
## ЧИТАТЬ ПЕРВЫМ: В ПРОЕКТЕ ДВЕ ЛИНИИ, И ДИРЕКТИВЫ У НИХ РАЗНЫЕ

С 07-27 в репозитории две независимые линии. Прежде чем что-либо делать, надо
понять, к какой относится задача — иначе директивы будут применены не туда.

**ВОЛНОВАЯ ЛИНИЯ** — весь этот файл ниже, `PLAN.md`, `src/` кроме
`src/transport/`, стенды `tools/tdg2d.c`, `tools/slab2d.c`, `tools/slice2d.c`.
Уравнение Гельмгольца, несущий (Трефтц) базис, фаза, голограммы и когерентная
оптика. ЖИВА и не сворачивается: она же будет считать BRDF для микрорельефа.
