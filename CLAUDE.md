...
проведён аудит ЭТОГО ПЛАНА (Г18…Г33). Из порядка работ **выполнены пункты 2, 4, 3 и часть 5 (фасетизация примитива)
...
`PLAN_CUT.md`. Следующее — Р-5б/в (эрмитовы данные, QEF, обход DC и шов уровней),
затем пункт 6 (потребители: T4 и хвост №5). Р-5г/д не пишутся: замер носителей
требует сцены T7, которой нет, а гомогенизация — машинерия ПЕРЕНОСА.
