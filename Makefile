...
build/render3: tools/render3.c src/transport/gather3.c src/transport/krylov3.c src/transport/sweep3.c src/transport/mesh3.c src/transport/cut3.c \
               src/transport/dirs3.c src/transport/tet3.c src/transport/quad.c \
               src/transport/ray3.c src/transport/cam3.c src/cut/poly3.c src/cut/surf.c \
               src/octree.c src/image.c | build
	$(RUN) 'gcc $(CFLAGS) -o $@ tools/render3.c src/transport/gather3.c src/transport/krylov3.c src/transport/sweep3.c src/transport/mesh3.c \
