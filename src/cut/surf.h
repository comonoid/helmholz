...
typedef struct {
  ...
  /* Р-8: ОГРАНИЧЕННЫЙ КУСОК — вершины треугольника-родителя, ЕДИНИЦЫ кадра.
   * bounded = 0 — куска нет, фасет режет как бесконечная плоскость (прежнее
   * поведение; так приходят аналитическая фасетизация Р-5а и прямые
   * плоскости). Побитовая общность Г3 переносится с плоскости на кусок:
   * вершины полигона — общие данные всех кусков веера, смежные куски делят
   * ребро побитово, соседние коробки клипуют ОДИН кусок. */
  int32_t bounded;
  double tv[3][3];
} hz_facet;
